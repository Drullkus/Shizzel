...
public class BeeGenomeManager {
	...
	private static IAllele[] getTemplateModBase() {
		...
		genome[EnumBeeChromosome.SPECIES.ordinal()] = BeeSpecies.CHISEL;
	...
	public static IAllele[] getTemplateChisel()
	{
		IAllele[] genome = getTemplateModBase();

		genome[EnumBeeChromosome.SPECIES.ordinal()] = BeeSpecies.CHISEL;
		genome[EnumBeeChromosome.EFFECT.ordinal()] = Allele.chiselGrief;
